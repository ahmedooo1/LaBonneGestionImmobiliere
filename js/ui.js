...
function showScoreHistory() {
    ...
    console.log(
        "Modal ajouté au DOM avec styles modernes. Vérifiez dans les outils de développement.",
        modal,
    );
}
...
document
    ...
    .addEventListener("click", showScoreHistory); // Assurez-vous que le bouton existe dans HTML
